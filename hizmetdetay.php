        ...
        <div class="row">
            <div class="col-md-12">
                <h1></h1>
					   ...
					   <li><a rel="v:url" property="v:title" href="hizmetler.html">Hizmetler</a></li>
          ...
          <div class="col-md-9">
            <div class="blog-single">
              <article>
                        ...
                        <img src="uploads/hizmetler/<?php echo $sayfa->resim;?>" alt="" class="img-responsive">
                      </div>
                  ...
                  <div class="post-metadata">                                                              
					  ...
					  <i class="fa fa-folder-open"></i> <a href="#" rel="category tag">Hizmetler</a></span>    
                  </div>
                <div class="hr"></div>
