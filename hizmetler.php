...
<section id="subheader" data-speed="8" data-type="background" class="subheader padding-top-bottom">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>Hizmetlerimiz</h1>
                                    <ul class="breadcrumbs"><li><a rel="v:url" property="v:title" href="index.html">Anasayfa</a></li><li class="active">Hizmetlerimiz</li></ul>                    
            </div>
        </div>
    </div>
</section>
...
<div id="content">
 ...
 ?>   
                    ...
                    <div class="post-media">
					      					      					      					      ...
					      					      					      					      <img width="360" height="270" src="uploads/hizmetler/<?php echo $haberSonuc->resim;?>" alt="" class="img-responsive" />
					     					                        <div class="post-date">
        ...
        <span class="date-month"><?php echo substr($haberSonuc->tarih,2,4);?></span>                        </div>
                    ...
                    <div class="post-content">
                        <div class="post-title">
                            <h5><a href="hizmet-detay-<?php echo $haberSonuc->seo;?>.html"><?php echo $haberSonuc->adi;?></a></h5>
                        </div>
